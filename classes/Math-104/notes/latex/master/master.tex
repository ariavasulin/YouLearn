...
% SYLLABUS
%----------------------------------------------------------------------
\subfile{../syllabus/syllabus}
\newpage

%----------------------------------------------------------------------
% LECTURES — demote \section→\subsection, \subsection→\subsubsection
%            so lectures nest under the "Lectures" section in the outline
%----------------------------------------------------------------------
\section{Lectures}
...
% ADD_LECTURE_HERE — agent appends new \subfile lines above this comment
...
% SESSIONS
%----------------------------------------------------------------------
\subfile{../sessions/sessions}
\newpage

%----------------------------------------------------------------------
% RESOURCES
%----------------------------------------------------------------------
\subfile{../resources/resources}
\newpage
...
%----------------------------------------------------------------------
% INDEX OF DEFINITIONS (auto-generated from \defn{} via makeindex)
%----------------------------------------------------------------------
